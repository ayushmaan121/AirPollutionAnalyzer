...
<body>
	<div class = "box">
		...
		<img src="icon.jpg" align="left" height="200px">
	</div>
	<div class="bar">
		<ul class="ul_style">
			<li class="li_style"><div class="dropdown">
				    ...
				    <div class="dropdown-content">
				      <a href="http://airmonitor1.000webhostapp.com/data/data1.php" style="font-family: 'Mina', san-serif">Node 1</a>
				      <a href="http://airmonitor1.000webhostapp.com/data/data2.php" style="font-family: 'Mina', san-serif">Node 2</a>
				      <a href="http://airmonitor1.000webhostapp.com/data/data3.php" style="font-family: 'Mina', san-serif">Node 3</a>
				      <a href="http://airmonitor1.000webhostapp.com/data/data4.php" style="font-family: 'Mina', san-serif">Node 4</a>
				    </div>
  				</div> 
  			</li>
  ...
  <input type="submit">
    ...
    echo $date;
    $node = 'Node4';
     $sql = "SELECT * FROM ".$node." WHERE Date = '$date'";
    $result=mysqli_query($dbconnect,$sql);
    echo "<br> Selected Node: ";
    echo $node;
    echo "<br> ";
	...
	<?php
	$sql2 = "SELECT * FROM ".$node." ORDER BY SerialNo DESC";
